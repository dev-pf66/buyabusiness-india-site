...
const navigation = [
  ...
  { name: "Calculator", href: "/resources/calculator" },
        ...
        <div className="flex h-16 items-center justify-between">
          ...
          <Link href="/" className="flex items-center space-x-2">
            <span className="text-xl font-bold text-gray-900">
              Buy a Business<span className="text-emerald-600"> India</span>
            </span>
          </Link>
        ...
        {mobileMenuOpen && (
          <div className="md:hidden py-4 border-t border-gray-100">
            <div className="flex flex-col space-y-4">
              ...
              <Link
                href="/newsletter"
                className="inline-flex items-center justify-center rounded-lg bg-emerald-600 px-4 py-2 text-base font-semibold text-white hover:bg-emerald-700"
                onClick={() => setMobileMenuOpen(false)}
              >
                Subscribe
              </Link>
